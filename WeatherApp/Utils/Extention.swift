...
extension Color{
    ...
    static let background = LinearGradient(gradient: Gradient(colors: [Color("Background 1"), Color("Backgroound2")]),
                                                                       startPoint: .topLeading, endPoint: .bottomLeading)
    
    
    static let bottomSheetBackground = LinearGradient(gradient: Gradient(colors: [Color("Background 1").opacity(0.26)]), startPoint: .topLeading, endPoint: .bottomTrailing)
    ...
    static let forecastCardBachground = Color("Forecast Card Background")
...
//This method add a Blur to view
extension View{
    
    func  backgroundBlur(radius: CGFloat = 3, opaque: Bool = false ) -> some View{
        self
            .background(Blur(radios: radius, opaque: opaque))
